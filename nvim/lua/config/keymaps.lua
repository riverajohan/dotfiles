...
map("n", "<leader>w", "<cmd>w<cr>", { desc = "Save buffer", noremap = true, silent = true })
-- map("n", "<leader>c", "<cmd>bdelete<cr>", { desc = "Close Tab", noremap = true, silent = true })
...
map("n", "<C-l>", "<C-w>l", { desc = "Go to rightCommentToggle window", remap = true })

-- Resize window using <ctrl> arrow keys
map("n", "<C-Up>", "<cmd>resize +2<cr>", { desc = "Increase window heigCommentToggleht" })
...
if Util.has("bufferline.nvim") then
  ...
  map("n", "<M-h>", "<cmd>BufferLineMovePrev<cr>", { desc = "Next buffer" })
  map("n", "<M-l>", "<cmd>BufferLineMoveNext<cr>", { desc = "Next buffer" })
else
